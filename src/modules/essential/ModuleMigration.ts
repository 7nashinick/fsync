...
import { ModuleFsync } from "@/features/Fsync/ModuleFsync.ts";
...
export class ModuleMigration extends AbstractModule<LiveSyncCore> {
    ...
    initialMessage() {
        // Fsync replaces the LiveSync onboarding invitation + wizard with a
        // single connect dialog. See src/features/Fsync/ModuleFsync.ts.
        this.core.getModule(ModuleFsync).openConnect();
    }
